...
class ProxyKeyService {
    ...
    async createProxyKey(organizationId, projectId, userId, name = '') {
        ...
        `)
            ...
            logger.error(`Create proxy key error: ${error.message}`, 'PROXY_KEYS');
            throw error;
        }
    }
    ...
    async getProxyKeys(projectId, organizationId) {
        ...
        `)
            ...
            logger.error(`Get proxy keys error: ${error.message}`, 'PROXY_KEYS');
            throw error;
        }
    }
    ...
    async getProxyKey(keyId, organizationId) {
        ...
        `)
            ...
            logger.error(`Get proxy key error: ${error.message}`, 'PROXY_KEYS');
            throw error;
        }
    }
    ...
    async revokeProxyKey(keyId, organizationId) {
        try {
            ...
            logger.error(`Revoke proxy key error: ${error.message}`, 'PROXY_KEYS');
            throw error;
        }
    }
   ...
   */
    async verifyProxyKey(keyValue) {
        ...
        `)
            ...
            logger.error(`Verify proxy key error: ${error.message}`, 'PROXY_KEYS');
    ...
    async getKeyCount(projectId, organizationId) {
        try {
            ...
            logger.error(`Get key count error: ${error.message}`, 'PROXY_KEYS');
            throw error;
        }
    }
}
